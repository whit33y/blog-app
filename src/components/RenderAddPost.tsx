...
function RenderAddPost() {
    ...
    const formSchema = yup.object({
        ...
        description: yup.string().min(50, 'Description is too short').required('Description is required'),
        category: yup.string().oneOf(['it', 'tech', 'health', 'lifestyle'], 'Wrong category').required('Category is required'),
    }).required();
