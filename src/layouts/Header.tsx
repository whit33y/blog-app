        ...
        <header>
            <div className='flex flex-row justify-around border-b-2 border-emerald-500'>
                ...
                <div className={isNavOpen ? 'block md:hidden' : 'hidden'}>
                    <div className="flex flex-col">
                        <div>
                            <h1 className="text-md text-emerald-500">Blog-app</h1>
                        </div>
                        <div className="flex flex-col">
                            <a href='/'>Home</a>
                ...
                {isNavOpen ?
                    ...
                    :
                    <div className="block md:hidden" onClick={() => handleClick()}>
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 fill-black" viewBox="0 0 24 24" stroke="currentColor">
