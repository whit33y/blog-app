    ...
    return (
        <Boilerplate name={'About me and about a project'}>
            <div className="flex flex-col items-center mt-5 sm:mx-0 md:mx-20 bg-slate-200">
                <img src='https://www.svgrepo.com/show/4559/man.svg' className="w-6 h-6" alt='man icon' />
                ...
                <img src='https://www.svgrepo.com/show/422049/website.svg' className="w-6 h-6" alt='computer icon' />
